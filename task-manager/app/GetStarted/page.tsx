...
function Page() {
  ...
  const visionSchema = z.object({
    vision: z
      .string()
      .min(10, { message: "Vision must be at least 10 characters long." }),
    purpose: z
      .string()
    ...
    specificGoals: z
      .string()
      .min(10, {
        message: "Specific goals must be at least 10 characters long.",
      }),
  });
  ...
  const handleInputChange =
    (field: keyof typeof visionPurposeGoals) =>
  ...
  const steps = [
    {
      ...
      description:
        "Imagine your ideal future. What does success look like to you?",
      field: "vision",
            ...
            <Form {...visionForm}>
              <form
                ...
                onSubmit={visionForm.handleSubmit((data) => {
                  setFormInfo((prev) => [
                    ...prev,
                    data[currentStep.field as keyof typeof data],
                  ]);
                  setVisionPurposeGoals((prev) => ({
                    ...prev,
                    [currentStep.field]:
                          ...
                          <FormControl>
                            <Textarea
                              ...
                              onChange={(e) => {
                                field.onChange(e);
                                handleInputChange(
                                  currentStep.field as keyof typeof visionPurposeGoals
                                )(e);
                              }}
                            />
                          </FormControl>
                ...
                <Dialog>
                  ...
                  <DialogContent className="sm:max-w-[425px]">
                    <DialogHeader>
                      ...
                      <DialogDescription>
                        Here&apos;s a summary of your goals and actionable
                        steps.
                      </DialogDescription>
                    </DialogHeader>
